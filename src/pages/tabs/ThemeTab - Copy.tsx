          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="p-5 rounded-2xl border border-[#5A5CE6]/30 bg-[#5A5CE6]/5 flex flex-col gap-3 relative overflow-hidden">
                ...
                <p className="text-[10px] text-indigo-200/60 uppercase tracking-widest leading-relaxed">
                  Creates a 1x1, circular, minimalist, futuristic, vibrant AI icon based on your brand name.
                </p>
