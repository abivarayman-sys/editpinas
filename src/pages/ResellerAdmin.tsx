...
export default function ResellerAdmin() {
  ...
  const handleGenerateAILogo = async () => {
    ...
    // Determine the prompt: use user input if available, otherwise use your new default
    const finalPrompt = logoPrompt.trim() !== '' 
      ? logoPrompt 
      : "Create a minimalist tech company logo in aspect ratio 1:1. The logo should feature clean geometric shapes forming an abstract circuit inspired symbol, thin balanced lines, smooth curves, and subtle gradients.";
    ...
    try {
      ...
      // 2. Simulate AI Generation with the specific prompt
      // In production, you would pass 'finalPrompt' to your Gemini/Imagen API call here
      console.log("Generating with prompt:", finalPrompt); 
      
      await new Promise(resolve => setTimeout(resolve, 3500));
      
      // Mock result (this will be replaced by your real AI image URL)
